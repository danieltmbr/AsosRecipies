...
enum RecipesEndpoints {
    case all
}

// MARK: -

extension RecipesEndpoints: TargetType {

    var baseURL: URL {
        return URL(string: "http://mobile.asosservices.com/sampleapifortest")!
    }

    var path: String {
        switch self {
        case .all: return "recipes.json"
        }
    }
